Shader "Stylized/Sky"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                    // Adjust the horizon by subtracting a value (e.g., 0.2) from the y-component.
                float horizonOffset = -7000;
                float maskHorizon = dot(normalize(i.worldPosition - float3(0, horizonOffset, 0)), float3(0, 1, 0));
